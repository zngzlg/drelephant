...
import org.apache.spark.deploy.history.SparkSQLFetcher
...
/**
  ...
  */
class TDWFetcher(fetcherConfigurationData: FetcherConfigurationData)
  extends ElephantFetcher[SparkApplicationData] {
  lazy val legacyFetcher = new SparkSQLFetcher(fetcherConfigurationData)
