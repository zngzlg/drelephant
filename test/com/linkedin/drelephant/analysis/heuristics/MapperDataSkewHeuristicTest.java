...
public class MapperDataSkewHeuristicTest extends TestCase {
    ...
    public void testApplyFail() throws Exception {
        ...
        counter_a.set(HadoopCounterHolder.CounterName.HDFS_BYTES_READ, 1024 * 1024 * 1024); //1GB
        counter_b.set(HadoopCounterHolder.CounterName.HDFS_BYTES_READ, 10 * 1024 * 1024); //10MB
        counter_c.set(HadoopCounterHolder.CounterName.HDFS_BYTES_READ, 10 * 1024 * 1024); //10MB
    ...
    public void testApplySuccess() throws Exception {
        ...
        counter_a.set(HadoopCounterHolder.CounterName.HDFS_BYTES_READ, 10 * 1024 * 1024); //10MB
        counter_b.set(HadoopCounterHolder.CounterName.HDFS_BYTES_READ, 10 * 1024 * 1024); //10MB
        counter_c.set(HadoopCounterHolder.CounterName.HDFS_BYTES_READ, 10 * 1024 * 1024); //10MB
